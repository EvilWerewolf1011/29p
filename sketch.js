...
function detectCollision(lrock,lmango){
	...
	if(lrock.body.position.x- lmango.body.position.x <lmango.diametre + lrock.diametre
		&& lmango.body.position.x - lrock.body.position.x  < lmango.diametre + lrock.diametre
		&&lrock.body.position.y -lmango.body.position.y < lmango.diametre + lrock.diametre
		&& lmango.body.position.y - lrock.body.position.y < lmango.diametre + lrock.diametre){
